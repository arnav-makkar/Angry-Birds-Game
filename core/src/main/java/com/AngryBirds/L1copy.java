...
public class L1copy implements Screen {
    ...
    public L1copy(Game game) {this.game = game;}
...
//        music.play();
        ...
        inputMultiplexer.addProcessor(new InputAdapter() {
            ...
            public boolean touchDown(int screenX, int screenY, int pointer, int button) {
                ...
                if (birdTextM.get(prevBird).equals(yellowBirdTexture)) {
                    if (Gdx.input.justTouched()) {
                        triggerSpecialYellow(prevBird);
                    }
                }
    ...
    private void triggerSpecialBlack(Body bird) {
        bird.setLinearVelocity(bird.getLinearVelocity().x*1.5f, bird.getLinearVelocity().y*-1);
    }


    private void triggerSpecialYellow(Body bird) {
//        bird.setLinearVelocity(bird.getLinearVelocity().x*1.5f, bird.getLinearVelocity().y*-1);
    }
